                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    <span className="subtitle">CYBER SECURITY SOLUTIONS</span>
                                    ...
                                    <div className="button-group">
                                        <a className="btn-default btn-medium round btn-icon" target="_blank" href="/">Purchase Now <i className="icon"><FiArrowRight /></i></a>
