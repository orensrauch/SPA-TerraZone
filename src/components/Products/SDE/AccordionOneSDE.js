...
const AccordionOneSDE = ({customStyle}) => {
    return (
        <Accordion className={`rn-accordion-style ${customStyle}`} defaultActiveKey="0">
            <Card>
                <Card.Header>
                <Accordion.Toggle as={Button} variant="link" eventKey="0">
                    What is SDE ? How does it work?
                </Accordion.Toggle>
                </Card.Header>
                <Accordion.Collapse eventKey="0">
                    <Card.Body>SDE stands for Secure Data Exchange, simply saying it is secure Email with advanced automations and Blockchain* encryption level vaults for file sharing. </Card.Body>
                </Accordion.Collapse>
            </Card>
            ...
            <Card>
                ...
                <Accordion.Toggle as={Button} variant="link" eventKey="1">
                    How can I run SDE on the cloud?
                </Accordion.Toggle>
                </Card.Header>
...
export default AccordionOneSDE
