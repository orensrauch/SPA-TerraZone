...
import AccordionOneHeimdall from './AccordionOneHeimdall'

const MissionHeimdall = () => {
    return (
                ...
                <div className="row row--30">
                    <div className="col-lg-6">
                        <div className="mission-title">
                            <h2 className="title">Heimdall Mission <br /> {" "}
                    ...
                    <div className="col-lg-6 mt_md--30 mt_sm--30">
                        <AccordionOneHeimdall customStyle="" />
                    </div>
                </div>
            </div>                        
        </div>
...
export default MissionHeimdall;
